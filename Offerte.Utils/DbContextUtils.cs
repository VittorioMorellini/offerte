...
namespace Offerte.Utils
{
    public static class DbContextUtils
    {
        static DbContextUtils()
        {
            ...
            //Z.EntityFramework.Extensions.LicenseManager.AddLicense("2907;101-Sixtema", "70019288-c423-e001-b841-21c8f1c1b1fb");
        ...
        //public static void Save<TEntity>(this DbContext context, IEnumerable<TEntity> entities) where TEntity : class
        //{
